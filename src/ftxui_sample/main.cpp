...
// configuration step. It creates a namespace called `ci_cd`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", ci_cd::cmake::project_name, ci_cd::cmake::project_version) };
